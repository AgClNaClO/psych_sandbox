...
4. 导出各流派每 session 与整体 Client/Counselor 量表、纵向趋势和安全/泄漏事件。
...
每 session 与整体的 PsychEval 督导都是外部评测，不作为 D/E 的逐 session 反馈变量（下一计划仍由咨询师自评与纵向信号决定）。研究督导反馈闭环时应建立单独实验分支，避免与当前咨询师自评和纵向计划机制混淆。
